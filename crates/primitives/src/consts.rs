...
/// ELFs generated by dump-elf / bootloader might have non-zero values
/// set in the stack. SP1 does not allow loading to addresses below
/// 0x78000000 from ELF values. To preserve this limitation, programs
/// which might dump elf will have an extra 16MB area used as stack.
pub const DUMP_ELF_EXTRA_STACK: u64 = 0x1000000;

/// Untrusted program header flag
pub const PF_UNTRUSTED: u32 = 0x00100000;
...
/// Section name for profiler stack
